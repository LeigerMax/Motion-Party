...
// Gère la reconnaissance vocale en temps réel avec Vosk dans un projet Unity.
public class VoskSpeechToText : MonoBehaviour
{
	[Tooltip("Location of the model, relative to the Streaming Assets folder.")]
	public string ModelPath = "vosk-model-small-fr-0.22.zip";
	...
	private IEnumerator DoStartVoskStt(bool startMicrophone)
	{
		...
		{
			Debug.LogError("VoiceProcessor is not assigned. Please assign it in the inspector.");
