...
public class DebugPanel_Score : BaseDebugPanel
{
    ...
    protected override void Start()
    {
        ...
        panelTitle = "Score Debug";        // Auto-découverte du ScoreManager
    ...
    private void AddTestScore(int points)
    {
        ...
        if (points == 0)
        {
            LogParadeLogger.LogVerbose("[DebugPanel_Score] Aucun point à ajouter (valeur = 0)");
            return;
        }
        ...
        if (addManualMethod != null)
        {
            ...
            LogParadeLogger.LogVerbose($"[DebugPanel_Score] ✅ {points} points ajoutés via AddPointsManual() - Score: {GetCurrentScore()}");
            return;
        }
        ...
        if (addMethod != null)
        {
            ...
            LogParadeLogger.LogVerbose($"[DebugPanel_Score] ✅ {points} points ajoutés via AddPoints() - Score: {GetCurrentScore()}");
            return;
        }
        ...
        if (addScoreMethod != null)
        {
            ...
            LogParadeLogger.LogVerbose($"[DebugPanel_Score] ✅ {points} points ajoutés via AddScore() - Score: {GetCurrentScore()}");
            return;
        }
    ...
    private void SubtractTestScore(int points)
    {
        ...
        if (subtractManualMethod != null)
        {
            ...
            LogParadeLogger.LogVerbose($"[DebugPanel_Score] ✅ {points} points retirés via SubtractPointsManual() - Score: {GetCurrentScore()}");
            return;
        }
        ...
        {
            addMethod.Invoke(scoreManager, new object[] { -points });
            LogParadeLogger.LogVerbose($"[DebugPanel_Score] ✅ {points} points retirés via AddPoints(-{points}) - Score: {GetCurrentScore()}");
            return;
        }
    ...
    private void ResetScore()
    {
        ...
        if (resetMethod != null)
        {
            ...
            LogParadeLogger.LogVerbose("[DebugPanel_Score] Score réinitialisé");
        }
        else
        {
            ...
            if (setMethod != null)
            {
                ...
                LogParadeLogger.LogVerbose("[DebugPanel_Score] Score mis à 0");
            }
            else
            {
    ...
    private void MultiplyScore(int multiplier)
    {
        ...
        LogParadeLogger.LogVerbose($"[DebugPanel_Score] Score multiplié par {multiplier}: {currentScore} → {newScore}");
    }    /// <summary>
    ...
    private void ToggleScoring()
    {
        ...
        if (currentlyScoring)
        {
            ...
            if (stopMethod != null)
            {
                ...
                LogParadeLogger.LogVerbose("[DebugPanel_Score] 🛑 Scoring arrêté");
            }
        }
        else
        {
            ...
            if (startMethod != null)
            {
                ...
                LogParadeLogger.LogVerbose("[DebugPanel_Score] ▶️ Scoring démarré");
            }
        }
    }/// <summary>
    /// Formate un nombre avec décimales (masque la méthode héritée intentionnellement)
    /// </summary>
