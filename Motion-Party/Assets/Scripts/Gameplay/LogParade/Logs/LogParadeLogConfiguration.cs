...
public class LogParadeLogConfiguration : MonoBehaviour
{
    ...
    {
        if (showDebugInfo)
            LogParadeLogger.LogVerbose($"[LogConfiguration] {message}");
    }

    private void LogError(string message)
    {
        LogParadeLogger.LogError($"[LogConfiguration] {message}");
    }

    private void LogWarning(string message)
    {
        LogParadeLogger.LogWarning($"[LogConfiguration] {message}");
    }
    #endregion
}
