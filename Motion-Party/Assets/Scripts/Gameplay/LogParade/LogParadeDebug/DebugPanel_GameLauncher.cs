...
public class DebugPanel_GameLauncher : BaseDebugPanel
{
    ...
    protected override void Start()
    {
        ...
        {
            gameLauncher = FindObjectOfType<LogParadeGameLauncher>();
    ...
    private void StopAllSystems()
    {
        ...
        lastLaunchStatus = "Arrêt demandé";
        gameLauncher.StopAllSystems();
        Debug.Log("[DebugPanel_GameLauncher] Arrêt de tous les systèmes demandé");
    }
