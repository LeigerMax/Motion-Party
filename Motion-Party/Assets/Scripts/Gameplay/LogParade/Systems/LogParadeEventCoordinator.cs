...
public class LogParadeEventCoordinator : MonoBehaviour
{
    ...
    #region Structure pour l'historique
    ...
    #region Méthodes de déclenchement d'événements
    ...
    #region Séquences d'événements orchestrées
